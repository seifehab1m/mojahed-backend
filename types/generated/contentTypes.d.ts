...
export interface ApiAboutAbout extends Schema.SingleType {
  ...
  attributes: {
    aboutAuthor: Attribute.Component<'about-author.about-author'> &
    ...
    faqSection: Attribute.Component<'faq.faq'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiContactusPageContactusPage extends Schema.SingleType {
  ...
  attributes: {
    ...
    socialMediaIcons: Attribute.Component<
...
export interface ApiEventEvent extends Schema.CollectionType {
  ...
  attributes: {
    ...
    descriptionAr: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiFoodFood extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    titleAr: Attribute.String & Attribute.Required;
    descriptionAr: Attribute.String & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiFooterFooter extends Schema.SingleType {
  ...
  attributes: {
    ...
    socialMediaIcons: Attribute.Component<'social-media-icons.social-media-icons'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHomeHome extends Schema.SingleType {
  ...
  attributes: {
    heroSection: Attribute.Component<'hero.hero', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    aboutSection: Attribute.Component<'about.about'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    eventSection: Attribute.Component<'event-section.event-section'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
